...
modelVertices := [?]ModelVertex {
	{position = {0.0, 0.0, 0.0}, uv_x = 0, uv_y = 1, normal = {0.0, 0.0, -1.0}},
	{position = {1.0, 0.0, 0.0}, uv_x = 1, uv_y = 1, normal = {0.0, 0.0, -1.0}},
	{position = {1.0, 1.0, 0.0}, uv_x = 1, uv_y = 0, normal = {0.0, 0.0, -1.0}},
	{position = {0.0, 1.0, 0.0}, uv_x = 0, uv_y = 0, normal = {0.0, 0.0, -1.0}},
	{position = {0.0, 0.0, 1.0}, uv_x = 0, uv_y = 1, normal = {0.0, 0.0, 1.0}},
	{position = {1.0, 0.0, 1.0}, uv_x = 1, uv_y = 1, normal = {0.0, 0.0, 1.0}},
	{position = {1.0, 1.0, 1.0}, uv_x = 1, uv_y = 0, normal = {0.0, 0.0, 1.0}},
	{position = {0.0, 1.0, 1.0}, uv_x = 0, uv_y = 0, normal = {0.0, 0.0, 1.0}},
	{position = {0.0, 0.0, 0.0}, uv_x = 1, uv_y = 1, normal = {-1.0, 0.0, 0.0}},
	{position = {0.0, 1.0, 0.0}, uv_x = 1, uv_y = 0, normal = {-1.0, 0.0, 0.0}},
	{position = {0.0, 1.0, 1.0}, uv_x = 0, uv_y = 0, normal = {-1.0, 0.0, 0.0}},
	{position = {0.0, 0.0, 1.0}, uv_x = 0, uv_y = 1, normal = {-1.0, 0.0, 0.0}},
	{position = {1.0, 0.0, 0.0}, uv_x = 0, uv_y = 1, normal = {1.0, 0.0, 0.0}},
	{position = {1.0, 1.0, 0.0}, uv_x = 0, uv_y = 0, normal = {1.0, 0.0, 0.0}},
	{position = {1.0, 1.0, 1.0}, uv_x = 1, uv_y = 0, normal = {1.0, 0.0, 0.0}},
	{position = {1.0, 0.0, 1.0}, uv_x = 1, uv_y = 1, normal = {1.0, 0.0, 0.0}},
	{position = {0.0, 0.0, 0.0}, uv_x = 0, uv_y = 0, normal = {0.0, -1.0, 0.0}},
	{position = {0.0, 0.0, 1.0}, uv_x = 0, uv_y = 1, normal = {0.0, -1.0, 0.0}},
	{position = {1.0, 0.0, 1.0}, uv_x = 1, uv_y = 1, normal = {0.0, -1.0, 0.0}},
	{position = {1.0, 0.0, 0.0}, uv_x = 1, uv_y = 0, normal = {0.0, -1.0, 0.0}},
	{position = {0.0, 1.0, 0.0}, uv_x = 0, uv_y = 0, normal = {0.0, 1.0, 0.0}},
	{position = {0.0, 1.0, 1.0}, uv_x = 0, uv_y = 1, normal = {0.0, 1.0, 0.0}},
	{position = {1.0, 1.0, 1.0}, uv_x = 1, uv_y = 1, normal = {0.0, 1.0, 0.0}},
	{position = {1.0, 1.0, 0.0}, uv_x = 1, uv_y = 0, normal = {0.0, 1.0, 0.0}},
}
